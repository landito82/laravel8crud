    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="articulos/create" class="btn btn-primary mb-4" role="button">Crear</a>
                        <table id="articulos" class="table mt-4 table-hover">
                                        ...
                                        <td>
                                            <div class="btn-toolbar" role="toolbar">
                                                <div class="btn-group mr-1" role="group">
                                                    <a href="/articulos/<?php echo e($articulo->id); ?>/edit"
                                                        class="btn btn-secondary btn-sm" role="button">Editar</a>
                                                </div>
                                                <div class="btn-group mr-1" role="group">
                                                    <form action="<?php echo e(route('articulos.destroy', $articulo->id)); ?>"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\laravel8crud\resources\views/articulo/index.blade.php ENDPATH**/ ?>